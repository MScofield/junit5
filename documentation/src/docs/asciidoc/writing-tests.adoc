...
`DynamicContainer` are composed of a _display name_ and a list of dynamic child nodes, enabling
the creation of arbitrary nested hierarchies of dynamic nodes.
